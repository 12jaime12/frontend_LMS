  ...
  return (
    <>
      <div className="Profile2">
        <H1C
          text="Introduce SÓLO los datos que quieras cambiar"
          width="extralargo"
        />
        <LayoutForm
          direction="column"
          ...
          >
            <form onSubmit={handleSubmit(formSubmit)}>
              <div className="divUpdateImagen">
                <img
                  src={infoUser?.data?.imagen}
                  alt={infoUser?.data?.imagen}
                />
                {/* <label>
                  <input 
                  type="file" 
