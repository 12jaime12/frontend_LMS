...
const Login = () => {
  ...
  return (
    <>
      <div className="Login">
        <LayoutInline gap="3rem" padding="1rem" flexMedia="column">
          <LayoutFlex direction="column" gap="0.5rem" padding="1rem">
            ...
            >
              <H3C
                text="Bienvenid@ a Legendary Motorsport"
                width="extralargo"
              />
              ...
              <form onSubmit={handleSubmit(formSubmit)}>
                ...
                <LayoutFlex direction="column" gap="2rem" padding="2rem">
                  <Button
                    ...
                    color="white"
                  />
                  <Link to="/forgotpassword" className="anchorCustomSmall">
          ...
          <div className="ventajas-registro">
            ...
            >
              <H3C
                text="Las ventajas de tener una cuenta:"
                width="extralargo"
                align="left"
              />
              <ul>
                <li className="listaLogin">
                  <PC
                    text="Accede a la personalización de nuestros coches de catálogo."
                    align="left"
                    width="extralargo"
                  />
                </li>
                <li className="listaLogin">
                  <PC
                    text="Vende tus vehículos o compra coches a otros particulares."
                    align="left"
                    width="extralargo"
                  />
                </li>
                <li className="listaLogin">
                  <PC
                    text="Revisa tu vehículo en el taller más cercano."
                    align="left"
                    width="extralargo"
                  />
                </li>
                <li className="listaLogin">
                  <PC
                    text="Mantente al día con la información más reciente sobre tus vehículos favoritos e interactúa con otros usuarios."
                    align="left"
                    width="extralargo"
                  />
                </li>
